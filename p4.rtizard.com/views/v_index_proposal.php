...
For the most recent 20 years of that period, much of our work was co-ordinated by a client-server 4D database I developed. For P4, I would like to write a web application from scratch to 
...
trying out one of two approaches: 1) using AJAX to initiate a web services request using SOAP (or REST?) to a remote server capable of responding to requests for data analysis;
or 2) using AJAX to request results from a small service on the web host with locally hosted tools, probably from the EMBOSS open-source collection.</p>
